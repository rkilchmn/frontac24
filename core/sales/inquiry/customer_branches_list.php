...
$sql = get_branches_search_sql($_GET["customer_id"], get_post("branch"));
$th = array("" => array('fun' => 'select_branch'), _("Ref"), _("Branch"), _("Contact"), _("Phone"));
$table =& new_db_pager('customer_branch_tbl', $sql, $th);
$table->width = "85%";
