...
$js .= get_js_history("OrderNumber", "OrderReference", "OrdersAfterDate", "OrdersToDate", "StockLocation", "SelectStockFromList", "customer_id");

page($_SESSION['page_title'], false, false, "", $js);

set_posts("OrderNumber", "OrderReference", "OrdersAfterDate", "OrdersToDate", "StockLocation", "SelectStockFromList", "customer_id");
//---------------------------------------------------------------------------------------------
